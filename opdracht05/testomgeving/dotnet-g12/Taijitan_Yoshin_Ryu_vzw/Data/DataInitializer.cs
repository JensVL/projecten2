    ...
    public class DataInitializer
    {
        ...
        public async Task InitializeData()
        {
            ...
            if (_dbContext.Database.EnsureCreated())
            {
                ...
                Trainingsmoment Woensdag = new Trainingsmoment(3, "Woensdag", "07:00", "23:59");
                Trainingsmoment Donderdag = new Trainingsmoment(4, "Donderdag", "07:00", "23:59");
                ...
                Develop1.AddTrainingsmoment(Woensdag);
                Develop2.AddTrainingsmoment(Woensdag);
                Develop1.AddTrainingsmoment(Dinsdag);

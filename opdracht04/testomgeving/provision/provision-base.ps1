...
# once the user logs on, cleanup the taskbar by removing the existing buttons and unpinning all applications
# Note: shell executes RunOnce commands ~10s after the user logs on
